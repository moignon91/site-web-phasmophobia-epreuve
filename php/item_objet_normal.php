...
<script>
    ...
    body.classList.toggle('Item_objet_normal')
</script>
<?php 
$servername ='localhost';
$username ='root';
$password ='';
$numeroid = $_GET['objetid'];

$pdo = new PDO("mysql:host=$servername;dbname=phasmophobia", $username, $password);

$nom = $pdo->prepare("SELECT * FROM objet_normal WHERE id = ?");
