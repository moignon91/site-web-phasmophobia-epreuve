...
<script>
    ...
    body.classList.toggle('entités_normal')
</script>
<?php 
        ...
        <table>
            <tr>
                ...
                <td style="padding-left: 30px">
                    <h3><strong>Faiblesse</strong></h3>
                </td>
            </tr>
            <tr>
                <td>
                <?php echo $result1['Forces'];?>
                </td>
                <td style="padding-left: 30px">
                <?php echo $result1['Faiblesse'];?>
                </td>
            </tr>
        </table>
        <br><br><br>
        <h3><strong>Preuve :</strong></h3>
        <br>
        <ul>
            <?php echo $result1['Preuve'];?>
        </ul>
        </div>
    </div>


    <?php $page = htmlspecialchars(3); 
